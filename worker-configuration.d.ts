/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5c7c2570fb52cc0a3d8daa4c85c08ef3)
...
declare namespace Cloudflare {
	...
	interface Env {
		ROWING_COURSES: KVNamespace;
		DB: D1Database;
		INTERVALS_CLIENT_ID: "configure-via-secret-or-dev-vars";
		INTERVALS_CLIENT_SECRET: "configure-via-secret-or-dev-vars";
		TOKEN_ENCRYPTION_KEY: "00000000000000000000000000000000";
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "INTERVALS_CLIENT_ID" | "INTERVALS_CLIENT_SECRET" | "TOKEN_ENCRYPTION_KEY">> {}
}
